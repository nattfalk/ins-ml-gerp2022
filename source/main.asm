...
*= spritespeed
    ...
    //alpa - musician
    //bigge   - coder
    //bitflippr - graphician
    //bjoppen - musician, graphician
    //bonefish    - coder
    //boogeyman - graphician, musician
    //corel   - graphician
    //corpsicle - musician
    //evarcha - graphician
    //jojo073 - graphician
    ...
    //tmx     - graphician
    //triace  - musician
    //dlx     - musician, graphician, designer
    //randy    - coder, graphician, designer, musician?
    //skurk   - coder
    //vedder  - organizer, musician, coder, designer

    *= text
	!scr "                                        "
	!scr "      welcome to the official           "
	!scr "         insane memberlist              "
	!scr "                                        "
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "               age : 43                 "
	!scr "  demoscener since : 1989               "
	!scr "          fun fact :                    "
	!scr "  demoscene memory :                    "
	!scr "                                        "
	!scr "                                        "
	!scr "                                        "

	!scr "screen 3 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen 4 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen 5 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen 6 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen 7 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen 8 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen 9 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen10 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen11 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen12 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen13 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen14 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen15 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen16 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen17 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen18 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen19 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen20 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen21 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen22 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen23 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen24 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen25 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	...
	!scr "screen26 template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
	!scr "template template template template temp"
